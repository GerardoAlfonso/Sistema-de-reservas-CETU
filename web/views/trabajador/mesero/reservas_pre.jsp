                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1><i class="gi gi-envelope"></i>Reservas presentes</small></h1>
                            </div>
                        </div>
                        ...
                        <div class="block full">
                            ...
                            <table id="ecom-products" class="table table-bordered table-striped table-vcenter">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-center"><strong>Estefany</strong></a></td>
                                        <td class="text-right hidden-xs">06-11-20</td>
                                        <td class="text-right hidden-xs"><strong>6</strong></td>
                                        <td class="hidden-xs">
                                            <span class="label label-success">9</span>
                                        </td>
                                        <td class="hidden-xs text-center">12:oo MD</td>
